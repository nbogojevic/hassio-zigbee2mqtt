<div align="center">
    ...
    <h1>Fork of Zigbee2MQTT Home Assistant addon</h1>
</div>

This add-on allows running 2 instances of zigbee2mqtt at the same time.
...
3. The repository includes three add-ons:
